 ...
 * from HIGH Ã¢â€ â€™ LOW (falling edge).
 * ------------------------------------------------------------- */
...
void lcd16x2_i2c_sendCommand(uint8_t command)
{
    ...
    /* Extract upper 4 bits (D7Ã¢â‚¬â€œD4) */
 ...
 *
 * Returns:
 * true  Ã¢â€ â€™ LCD found and initialized
 * false Ã¢â€ â€™ LCD not detected
 * ------------------------------------------------------------- */
